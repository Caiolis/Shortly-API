...
import { validateAdminUrl, validateURL } from "../middlewares/urlValidation.middleware.js";

// Controllers
import { getUrlById, openUrl, shortUrl, deleteUrl } from "../controllers/urls.controller.js";
